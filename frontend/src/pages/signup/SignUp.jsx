        ...
        <h1 className='text-3xl font-semibold text-center text-gray-300'>
            ...
            <form>
                <div>
                    ...
                    <input type='text' placeholder='Garv Solanki' className='w-full input input-bordered h-10' />
                </div>
                ...
                <div>
                    ...
                    <input type='text' placeholder='garvsolanki' className='w-full input input-bordered h-10'/>
                </div>
